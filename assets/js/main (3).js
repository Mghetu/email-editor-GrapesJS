...
<mjml>
  ...
  <mj-body background-color="#ffffff">
    ...
    <!-- Added an example mj-group to test group behaviour in the preview.  This
         ensures there is at least one mj-group on the canvas when no
         previously saved data exists, so we can verify that columns stay
         side by side in the mobile simulator.  Feel free to remove this
         section once you’ve confirmed the behaviour works as expected. -->
    <mj-section>
      <mj-group>
        <mj-column>
          <mj-text font-size="14px" font-weight="bold">Group Column 1</mj-text>
          <mj-text font-size="12px">Example content for column one.</mj-text>
        </mj-column>
        <mj-column>
          <mj-text font-size="14px" font-weight="bold">Group Column 2</mj-text>
          <mj-text font-size="12px">Example content for column two.</mj-text>
        </mj-column>
      </mj-group>
    </mj-section>
  </mj-body>
    ...
    editor.on('load', function () {
      ...
      style.innerHTML = [
        ...
        '  /*\n   * Override stacking behaviour for columns inside mj-group.\n   *\n   * When the email is rendered, MJML keeps group columns inline by adding\n   * extra CSS.  The GrapesJS preview does not include that CSS, so on\n   * narrow screens (.max-width:480px) all columns are set to 100% width\n   * and thus stack vertically.  To approximate MJML’s native behaviour,\n   * reset the width and max-width of group columns and display them\n   * as table-cells, letting the table layout engine distribute widths.\n   */',
        '  .mj-group .mj-column-per-100,',
        '  .mj-group .mj-column-per-50,',
        '  .mj-group .mj-column-per-33,',
        '  .mj-group .mj-column-per-66,',
        '  .mj-group .mj-column-per-25,',
        '  .mj-group .mj-column-per-75 {',
